const content = {
  intro: {
    ...
    description:
      "At Hack Reactor, I worked to improve the selection of qualified coding candidates. Starting from the analysis and comparison of student entrance and outcomes data, I identified, prototyped, and tested the highest-impact feature changes to their admissions testing app.",
  ...
  body: [
    ...
    },
    {
      ...
      imageDesc: `The original process versus the revamped process.</span> As the product owner, I promoted the creation of admission standards, a grading UI, and grading by an algorithm to increase the accuracy of selecting high-quality candidates. <br/><small>Diagram edited to redact proprietary info.</small>`,
    },
    {
    ...
    },
    {
      description: `After implementation and training, <span class="white-highlight">I monitored the success of the project over 6 months to ensure efficacy.</span> During this time, <span class="white-highlight">I implemented weekly evaluation procedures to reinforce staff skills and grading processes.</span> <br/><br/>
        After 6 months, the results were clear. We surpassed expectations to increase admissions efficacy - increasing graduation rate by 20% - and significantly increased grading throughput.`,
  ...
  conclusion: {
    header: "Summary",
    description: `This project challenged me as a product owner. <span class="white-highlight">I needed strong negotiation skills to gain access to data from the full funnel, was pushed to excel in analytics through sifting thousands of records, and exercised leadership to obtain buy-in from a team resistant to change.</span><br/><br/> In the end, we soared above expectations and helped create a flourishing learning environment that changed the lives of our students.`,
    imageDesc: "",
  },
};
